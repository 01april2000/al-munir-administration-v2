...
export default function SantriManagementPage() {
  ...
  const fetchSantri = useCallback(async () => {
    try {
      ...
      const smkSantri = data.santri.filter((s: Santri) => s.jenisSantri === "SMK");
      setSantriList(smkSantri);
      setError(null);
    } catch (err) {
  ...
  return (
    <div className="flex flex-col gap-6 p-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold">Manajemen Santri SMK</h1>
