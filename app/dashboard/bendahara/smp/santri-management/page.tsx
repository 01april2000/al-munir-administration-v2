...
export default function SantriManagementPage() {
  ...
  const fetchSantri = useCallback(async () => {
    try {
      ...
      // Filter only SMP santri
      const smpSantri = data.santri.filter((s: Santri) => s.jenisSantri === "SMP");
      setSantriList(smpSantri);
      setError(null);
    } catch (err) {
  ...
  return (
    <div className="flex flex-col gap-6 p-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold">Manajemen Santri SMP</h1>
          <p className="text-muted-foreground">Kelola data santri SMP</p>
        </div>
              ...
              <div className="space-y-2">
                ...
                <select
                  ...
                  onChange={(e) =>
                    setFormData({
                      ...formData,
                      kelas: e.target.value as KelasSmp,
                    })
                  }
