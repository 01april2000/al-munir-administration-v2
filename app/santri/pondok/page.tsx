...
import { Receipt, Wallet, Shirt, CheckCircle2, Clock, XCircle, ArrowDown, ArrowUp, CreditCard, TrendingUp, AlertCircle, Calendar, RefreshCw, Bell, User, Send, QrCode, MoreHorizontal, Sparkles, History, Settings, LogOut, Mail, Phone, MapPin, School } from "lucide-react"
...
type TransactionType = "syahriah" | "uang-saku" | "laundry"
...
async function getSantriData() {
  ...
  const response = await fetch(`${baseUrl}/api/santri/pondok`, {
    cache: "no-store",
    headers: {
          ...
          <>
            ...
            <div className="grid grid-cols-4 gap-3">
              <Button variant="outline" className="flex flex-col gap-2 h-auto py-4 rounded-2xl hover:bg-primary/5 hover:border-primary/20 transition-all duration-300 hover:-translate-y-1">
                ...
                <span className="text-xs font-medium">Syahriah</span>
              </Button>
              <Button variant="outline" className="flex flex-col gap-2 h-auto py-4 rounded-2xl hover:bg-primary/5 hover:border-primary/20 transition-all duration-300 hover:-translate-y-1">
                <div className="flex items-center justify-center w-10 h-10 rounded-xl bg-gradient-to-br from-emerald-500 to-green-600 text-white shadow-lg shadow-emerald-500/20">
            ...
            <Card className="overflow-hidden border-border/50 rounded-2xl">
              <CardContent className="p-6">
                <div className="flex flex-col items-center text-center">
                  ...
                  <p className="text-sm text-muted-foreground">Santri Pondok</p>
                </div>
              </CardContent>
            </Card>
