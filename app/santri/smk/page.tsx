...
import { Receipt, Wallet, Shirt, FileCheck, Briefcase, Trophy, CheckCircle2, Clock, XCircle, ArrowDown, ArrowUp, CreditCard, TrendingUp, AlertCircle, Calendar, RefreshCw, Bell, User, Send, QrCode, MoreHorizontal, Sparkles, History, Settings, LogOut, Mail, Phone, MapPin, School } from "lucide-react"
...
export default async function SantriSMKPage({
  ...
  // Process PKL transactions
  const pklTransaksi = transaksi.filter((t: any) => t.jenis === "PKL")
  ...
  // Process LKS transactions
  const lksTransaksi = transaksi.filter((t: any) => t.jenis === "LKS")
            ...
            <Card className="overflow-hidden border-border/50 rounded-2xl">
              <CardContent className="p-6">
                <div className="flex flex-col items-center text-center">
                  ...
                  <p className="text-sm text-muted-foreground">Santri SMK</p>
                </div>
              </CardContent>
            </Card>
